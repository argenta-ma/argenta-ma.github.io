...
return [
    ...
    'timestamp' => 1496927905,
    'checksum' => '9f9e4e86caedef500ce0415ee3975277',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/markdown' => [
                'file' => 'user/plugins/markdown/blueprints.yaml',
                'modified' => 1491910803
            ],
    ...
    'data' => [
        'items' => [
            ...
            'plugins.mathjax.active' => [
                ...
                'name' => 'plugins.mathjax.active',
                'validation' => 'strict'
            ],
            'plugins.mathjax.mathjax' => [
                'type' => 'tab',
                'name' => 'plugins.mathjax.mathjax',
                'validation' => 'strict'
            ],
            ...
            'plugins.mathjax.basic' => [
                'type' => 'tab',
                'name' => 'plugins.mathjax.basic',
                'validation' => 'strict'
            ],
            'plugins.mathjax.CDN' => [
                'type' => '_parent',
            ...
            'plugins.mathjax.tabs' => [
                'type' => 'tabs',
                'active' => 1,
                'class' => 'subtle',
                'name' => 'plugins.mathjax.tabs',
                'validation' => 'strict'
            ],
            'plugins.error' => [
                'form' => [
            ...
            'plugins.markdown.enabled' => [
                ...
                'name' => 'plugins.markdown.enabled',
                'validation' => 'strict'
            ],
            'plugins.markdown.built_in_css' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.markdown.built_in_css',
                'validation' => 'strict'
            ],
            'plugins.markdown.level_classes' => [
                'type' => 'selectize',
                'size' => 'large',
                'label' => 'Level classes',
                'classes' => 'fancy',
                ...
                'name' => 'plugins.markdown.level_classes',
                'validation' => 'strict'
            ],
            'plugins.simplesearch' => [
                'form' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'markdown' => [
                    'enabled' => 'plugins.markdown.enabled',
                    'built_in_css' => 'plugins.markdown.built_in_css',
                    'level_classes' => 'plugins.markdown.level_classes'
                ],
                'simplesearch' => [
